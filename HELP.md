...
| **Show Results** | Reopen the LAST solve's results for this analysis — plots, Touchstone export, PDF report, Show in 3-D View — **without running the solver again**. The results are stored on the analysis, so this is free and instant |
